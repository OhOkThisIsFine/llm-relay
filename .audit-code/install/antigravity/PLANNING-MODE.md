# Audit Code planning-mode guide

Open Antigravity in Planning mode, then follow the canonical loader below. Ask Antigravity to use `audit-code next-step` directly, and review Antigravity artifacts before accepting major code changes or imported evidence.
