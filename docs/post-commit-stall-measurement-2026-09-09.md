...
(`docs/backlog.md`), the measurement `docs/hedged-attempts-design-2026-08-30.md` §12 called for:
...
test, per `docs/hedged-attempts-design-2026-08-30.md` §12's own framing of the only honest
