...
- `HANDOFF.md` §0.4 says 24 of 33 lane-walk review findings are unverified. The review document
  (`docs/lane-walk-safety-review-2026-09-08.md`) does not list them by id, and v0.84.0 removed the
...
| "The llm-relay proxy daemon (v0.68.8) loads `config.json` ONCE" | Still true. Its claim that `docs/mcp-dispatch-prior-art-2026-08-30.md` is wrong is FALSE: that sentence describes the third-party `agent-dispatch` tool, not llm-relay. Correct the entry. See D2 for hot reload. |
