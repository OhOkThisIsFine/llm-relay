...
**Reference:** [docs/history/freellmapi-adoption-review-2026-08-13.md](freellmapi-adoption-review-2026-08-13.md) §6 Item 1
...
No files were modified. The status banner accurately describes the remaining gap: the first-event check landed, but full header deferral remains open on both fronts ([docs/history/freellmapi-adoption-review-2026-08-13.md:26-35](../../docs/history/freellmapi-adoption-review-2026-08-13.md)).
...
- **Repair path:** Run the outer probe before `repairPath`, so empty streams, early errors, and bad dialects never spend a reshaper call ([src/server.ts:685-690](../../src/server.ts#L685-L690)). Once the probe finds a native structured `tool_use`, repair behavior remains unchanged. Do not make an unrepaired schema-invalid tool call resume the candidate walk in this slice: that remains the separate owner decision in §2.1 ([docs/history/freellmapi-adoption-review-2026-08-13.md:184-190](../../docs/history/freellmapi-adoption-review-2026-08-13.md)). Valid or recovered tool-only streams may therefore commit and then use the current repair/error behavior ([src/server.ts:1799-1825](../../src/server.ts#L1799-L1825)).
