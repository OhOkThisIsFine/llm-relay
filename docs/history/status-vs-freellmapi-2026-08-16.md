...
Sources audited: `docs/history/alternatives-review-2026-08-09.md`, `docs/history/freellmapi-gap-proposals-2026-08-10.md`,
`docs/history/freellmapi-adoption-review-2026-08-13.md`, `docs/history/adoption-round2-decisions-2026-08-14.md`, and
...
3. **Four live references to the deleted `deployment-eligibility.ts`** — `CLAUDE.md:383`,
   `docs/pool-eligibility.md:97`, `docs/history/freellmapi-gap-proposals-2026-08-10.md:147`, and
...
12. **Three stale docs read as live**: `docs/history/alternatives-review-2026-08-09.md:352` still reads as a
    live "adopt it on trial" recommendation with no superseded marker (the trial concluded the other
    way on 2026-08-13); `docs/history/free-provider-setup-2026-07-29.md:114-127` reads as a live four-item
