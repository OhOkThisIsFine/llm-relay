...
| Codex (code-mode `exec`) | 2026-09-10 transcript sweep (`docs/history/dispatch-giveup-diagnosis-2026-09-10.md` §8) | The `exec` tool yields its script at 31.0 s; a longer MCP call loses its result. |
