...
- A new file implements the exact pattern highlighted in [docs/history/freellmapi-adoption-review-2026-08-13.md](../../docs/history/freellmapi-adoption-review-2026-08-13.md) §6 Item 1 (`__tests__/routes/*-fallback-convergence.test.ts`).
