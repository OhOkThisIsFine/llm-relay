...
`docs/history/quota-metering-spec-2026-08-16.md` §§2, 4, 6.3,
`docs/history/credential-fleet-design-2026-08-16.md` §§4-5, and
`docs/history/open-decisions-2026-08-16.md` M4-M6/C1-C4. No value is permanently presumed zero.
