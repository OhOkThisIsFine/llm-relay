...
`docs/history/reviews/duplication-and-complexity-catalog-2026-09-05.md:159` and planned as Family C of
`docs/history/reviews/refactor-plans/item-p1-02-context-limits-keystore.md`. It still carries its Phase 1a
