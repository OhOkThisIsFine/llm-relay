...
- `97b2f2b` — Documentation & baseline: `docs/dispatch-telemetry-design-2026-09-04.md` §6 Result, package baseline ratchet (`docs/dashboard-package-baseline.json`), `HANDOFF.md` §0 update, `docs/backlog.md` additions (MCP stale-config fallback and delegate-gate false positives).
