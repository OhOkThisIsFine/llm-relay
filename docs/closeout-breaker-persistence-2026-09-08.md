...
```
M HANDOFF.md
 M docs/breaker-persistence-audit-2026-09-08.md
?? docs/closeout-breaker-persistence-2026-09-08.md
```
...
M	HANDOFF.md
M	docs/breaker-persistence-audit-2026-09-08.md
M	docs/closeout-breaker-persistence-2026-09-08.md
...
(`docs/breaker-persistence-audit-2026-09-08.md` §3): after a hard kill and restart, `candidates`
...
1. *"Mutation check fails eight tests" — partially substantiated; the auditor counted 10–12.*
   ...
   Corrected in `docs/breaker-persistence-audit-2026-09-08.md` §4a and above; the commit message
